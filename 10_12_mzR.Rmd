...
ms_dat <- openMSfile("~/Local/QC_20230214_QE_Hela200ng_Aur2hr.mzML")
...
ms_dat <- openMSfile("~/Local/gitdata/QC_20230214_QE_Hela200ng_Aur2hr.mzML")
...
tbl_spec <- peaks(ms_dat, 1234) %>% as_tibble()
