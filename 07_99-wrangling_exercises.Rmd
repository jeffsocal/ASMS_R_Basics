...
met_df <- "data/messy-bacteria-data.xlsx" %>% read_excel(col_names = TRUE)
```

*In all proceed exercises, pipe results from previous exercise into current exercise creating a single lone pipe for data processing*
...
7. Remove the `User` column. See cheatsheet here: https://www.rstudio.com/wp-content/uploads/2015/02/data-wrangling-cheatsheet.pdf or consult internet.
