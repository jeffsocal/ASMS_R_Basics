...
```{r 4001, echo=FALSE, fig.cap="\\label{fig:4001}R main data structures", fig.height=100}
...
> **NOTE:**\
> _the use of an integer vector to sub-select another vector based on position._
> _also ... R abides by the 1:N positional referencing, where as other programming languages refer to the first vector or array position as 0. A good topic for a lively discussion with a computer scientist._
