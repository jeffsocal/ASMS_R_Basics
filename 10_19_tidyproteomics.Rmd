...
| **Web App**       | [tidyproteomics](bioinformatics.pel.caltech.edu/tidyproteomics/) |
| **Literature**    |                                                                  |
...
```{r, echo=FALSE, fig.width=8, fig.height=3, fig.align='center', eval=FALSE}
...
grid.arrange(p04 + labs(title = '', subtitle = 'p04: Normalization CVs'), 
             ...
             nrow = 1)
```
```{r, echo=FALSE, fig.width=8, fig.height=3, fig.align='center', warning=FALSE, message=FALSE, eval=FALSE}
