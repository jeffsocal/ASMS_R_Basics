...
+---------------------------------+------------------------------------------------------------------------------------------------------------------------------+
| ![](images/05.png){height="68"} | **Docs** | [web](https://msstats.org), [PDF](https://bioconductor.org/packages/release/bioc/manuals/MSstats/man/MSstats.pdf) |
|                                 |                                                                                                                              |
|                                 | **Code** | [Bioconductor](https://www.bioconductor.org/packages/release/bioc/html/MSstats.html)                              |
|                                 |                                                                                                                              |
|                                 | **Cite** | *Bioinformatics* 30.17 (2014): 2524-2526                                                                          |
+---------------------------------+------------------------------------------------------------------------------------------------------------------------------+
