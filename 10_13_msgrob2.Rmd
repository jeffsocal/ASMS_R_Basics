...
|                   |                                                                                                                                                                  |
|------------------|------------------------------------------------------|
| **Documentation** | [PDF](https://www.bioconductor.org/packages/release/bioc/manuals/msqrob2/man/msqrob2.pdf)                                                                        |
| **Code**          | [Bioconductor](https://www.bioconductor.org/packages/release/bioc/html/msqrob2.html)                                                                             |
| **Literature**    | *Molecular & Cellular Proteomics*, **15**(2), 657-668., *Molecular & Cellular Proteomics*, **19**(7), 1209-1219., *Analytical Chemistry*, **92**(9), 6278--6287. |
