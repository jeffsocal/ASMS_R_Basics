...
- R has become one of the top languages for data science, and it’s popularity and usage continues to grow
- For scientists, R is a great tool to learn

__Fast, nimble, forgiving__

__Lots of specialty tools (CRAN, Github, Bioconductor)__

## What you can do with it {-}
__Read and plot data__

__construct analysis pipelines__

__prototype new algorithms__

__write packages to share__
...
### Did you know {-}
__R can use functions from Python, C and Rust__
