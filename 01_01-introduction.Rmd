...
1.    Understand why R is a good choice for data analysis.\
2.    Understand that you have just started the learning curve and all your efforts hence forth are worth it.
:::
...
_**NOTES** Some helpful explanatory notes and tips appear as a block quote._\
\
R can is a fast, nimble, forgiving scripting language with lots of specialty tools and resources (CRAN, Github, Bioconductor).
:::
