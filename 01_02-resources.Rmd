...
+---------------------------------+----------------------------------------------------------------------------------------+
| ![](images/05.png){height="68"} | **R for Data Science: Import, Tidy, Transform, Visualize, and Model Data 1st Edition** |
...
+---------------------------------+---------------------------------------------+
| ![](images/05.png){height="68"} | **Use R!**, a collection of 67 print books. |
+---------------------------------+---------------------------------------------+
