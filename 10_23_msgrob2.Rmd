...
+---------------------------------+------------------------------------------------------------------------------------------------------+
| ![](images/05.png){height="68"} | **Docs** | [PDF](https://www.bioconductor.org/packages/release/bioc/manuals/msqrob2/man/msqrob2.pdf) |
|                                 |                                                                                                      |
|                                 | **Code** | [Bioconductor](https://www.bioconductor.org/packages/release/bioc/html/msqrob2.html)      |
|                                 |                                                                                                      |
|                                 | **Cite**  | *Molecular & Cellular Proteomics* 2016, **15**(2), 657-668.                              |
+---------------------------------+------------------------------------------------------------------------------------------------------+
